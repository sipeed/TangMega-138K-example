...
// PLL1
create_generated_clock -name cam_xclk -source [get_ports {clk}] -master_clock clk -divide_by 50  -multiply_by 24 [get_pins {Gowin_PLL_m0/PLL_inst/CLKOUT0}]
...
create_generated_clock -name mem_clk  -source [get_ports {clk}] -master_clock clk -divide_by 3   -multiply_by 24 [get_pins {Gowin_PLL_m0/PLL_inst/CLKOUT2}]

//PLL2
create_generated_clock -name clk_tmds_5x -source [get_ports {clk}] -master_clock clk -divide_by 40  -multiply_by 297 [get_pins {u_tmds_pll/PLL_inst/CLKOUT0}]
create_generated_clock -name clk_74_25   -source [get_ports {clk}] -master_clock clk -divide_by 200 -multiply_by 297 [get_pins {u_tmds_pll/PLL_inst/CLKOUT1}]
