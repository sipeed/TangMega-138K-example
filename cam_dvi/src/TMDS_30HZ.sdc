...
create_generated_clock -name mem_clk -source [get_ports {clk}] -master_clock clk -divide_by 1 -multiply_by 8 [get_pins {Gowin_PLL_m0/PLL_inst/CLKOUT2}]

//PLL2
create_generated_clock -name clk_tmds_5x -source [get_ports {clk}] -master_clock clk -divide_by 80  -multiply_by 297 [get_pins {u_tmds_pll/PLL_inst/CLKOUT0}]
create_generated_clock -name clk_74_25   -source [get_ports {clk}] -master_clock clk -divide_by 400 -multiply_by 297 [get_pins {u_tmds_pll/PLL_inst/CLKOUT1}]
